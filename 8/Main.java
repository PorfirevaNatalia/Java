...
public class Main {
    public static void main(String[] args) {
        ...
        laptops.add(new Laptop("Acer", 16, 512, "Linux", "Silver"));
        laptops.add(new Laptop("Apple", 8, 512, "MacOS", "Gold"));
        laptops.add(new Laptop("Sony", 32, 2048, "Windows", "Black"));
        laptops.add(new Laptop("RoverBook", 4, 256, "Linux", "Silver"));
        ...
        System.out.println("Заданным критериям соответствуют ноутбуки: ");
